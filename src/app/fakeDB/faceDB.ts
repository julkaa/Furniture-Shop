...
class FakeDB {
  ...
  public GetProductCardInfos(): Observable<ProductCard[]> {
    return of(
      [
        new ProductCard(1, "Syltherine", "Stylish cafe table", 2500000, "/assets/images/fakeDBImages/image 1.png", false, false, null, null),
        new ProductCard(2, "Syltherine", "Stylish cafe chair", 2500000, "/assets/images/fakeDBImages/image 2.png", false, true, 30, 3000000),
        new ProductCard(3, "Syltherine", "Stylish cafe sofa", 2500000, "/assets/images/fakeDBImages/image 3.png", true, false, null, null),
